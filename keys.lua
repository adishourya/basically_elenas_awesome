...
keys.globalkeys = gears.table.join(
	...
	awful.key(
		...
		{
			description = "pick a client by clicking to add to tabbing group",
			group = "Tabs"
		}
	),
	...
	awful.key(
		...
		{description = "Iterate through tabbing groups", group = "Tabs"}
	),
	...
	awful.key(
		...
		function()
			...
			-- awful.spawn.with_shell("rofi_run")
		end,
...
keys.clientkeys = gears.table.join(
	...
	awful.key({superkey, altkey}, "c", function(c)
