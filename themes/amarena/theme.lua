...
-- theme.font          = "sans 11"
theme.font          = "SFMono Nerd Font 11"
...
theme.titlebar_font = "SFMono Nerd Font bold 9"
-- Window title alignment: left, right, center
theme.titlebar_title_align = "center"
-- Titlebar position: top, bottom, left, right
theme.titlebar_position = "top"
theme.titlebar_bg = "#191c22"
theme.titlebar_bg_focus = "#191c22"
theme.titlebar_bg_normal = "#191c22"
theme.titlebar_fg_focus = x.color3
theme.titlebar_fg_normal = x.color5
theme.titlebar_fg = x.color1
...
theme.tabbar_radius = 6                     -- border radius of the tabbar
theme.tabbar_style = "modern"              -- style of the tabbar ("default", "boxes" or "modern")
theme.tabbar_font = "SFMono Nerd Font 11"               -- font of the tabbar
theme.tabbar_size = 40                      -- size of the tabbar
theme.tabbar_position = "top"               -- position of the tabbar
theme.tabbar_bg_normal = "#1a1d23"          -- background color of the focused client on the tabbar
theme.tabbar_fg_normal = "#dbdee9"          -- foreground color of the focused client on the tabbar
theme.tabbar_bg_focus  = "#2b2f3a"          -- background color of unfocused clients on the tabbar
theme.tabbar_fg_focus  = "#dbdee9"          -- foreground color of unfocused clients on the tabbar
...
theme.mstab_border_radius = 6               -- border radius of the tabbar
theme.mstab_bar_height = 40                 -- height of the tabbar
theme.mstab_tabbar_position = "top"         -- position of the tabbar (mstab currently does not support left,right)
theme.mstab_tabbar_style = "default"        -- style of the tabbar ("default", "boxes" or "modern")

-- the following variables are currently only for the "modern" tabbar style
theme.tabbar_color_close = "#bf616a"        -- chnges the color of the close button
theme.tabbar_color_min   = "#ebcb8b"        -- chnges the color of the minimize button
theme.tabbar_color_float = "#88c0d0"        -- chnges the color of the float button
...
theme.notification_font = "SFMono Nerd Font 11"
...
theme.wibar_border_color = "#434c5e"
theme.wibar_border_color = x.color3
...
--theme.taglist_bg_focus = "#ff0000"
 ...
 --Tasklist
theme.tasklist_font = "SFMono Nerd Font Italic 9"
...
theme.exit_screen_font = "SFMono Nerd Font 20"
...
-- Noodle Text Taglist
theme.taglist_text_font = "SFMono Nerd Font 25"
