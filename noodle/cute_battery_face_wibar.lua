...
-- local  happy_color     =  "#9c9ea6"
-- local  sad_color       =  "#9c9ea6"
-- local  ok_color        =  "#9c9ea6"
-- local  charging_color  =  "#dbdee9"
--
...
local bar_shape = function()
  return function(cr, width, height)
    gears.shape.partially_rounded_rect(cr, width, height, true, true, true, true, 2)
  end
end
...
local charging_icon = wibox.widget {
  ...
  align = "right",
  markup = helpers.colorize_text("", "#a3be8c"),
...
local cute_battery_face = wibox.widget {
  {
	...
	{
		nil,
		{nil, face, layout = wibox.layout.align.vertical, expand = "none"},
