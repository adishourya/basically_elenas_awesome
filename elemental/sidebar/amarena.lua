...
weather_widget_description.font = "SFMono Nerd Font 14"
local weather_widget_temperature = weather_widget:get_all_children()[3]
weather_widget_temperature.font = "SFMono Nerd Font 14"
...
mpd_title.font = "SFMono Nerd Font 14"
mpd_artist.font = "SFMono Nerd Font 10"
...
local bat = lain.widget.bat({
    settings = function()
        ...
        widget:set_markup(markup.font(time.font, markup(blue, bat_header) .. bat_p))
    end
})
...
-- music
local music_player = require("widget.mpd")
...
awful.placement.maximize_vertically(sidebar, { honor_workarea = true, margins = { top = 0 } })
